      ...
      dataService
        ...
        .then((res) => {
          ...
          if (id !== "") {
            ...
            if(props.Restaurant.deliverable===false){
              setdeliveryOption('store-pickup')
              localStorage.setItem('delivery_type','store-pickup')
            }else if(props.Restaurant.store_pickup===false){
              setdeliveryOption('delivery')
              localStorage.setItem('delivery_type','delivery')
            }else{
              // localStorage.setItem('delivery_type','delivery')  
        ...
        if (response.data.length > 0) {
          dataService
            ...
            .then((res) => {
              ...
              console.log("rest-resp", response);
          ...
          if(props.Restaurant.deliverable===false){
            setdeliveryOption('store-pickup')
            localStorage.setItem('delivery_type','store-pickup')
          }else if(props.Restaurantstore_pickup===false){
            setdeliveryOption('delivery')
            localStorage.setItem('delivery_type','delivery')
          }else{
            // localStorage.setItem('delivery_type','delivery')
          ...
          <div className="card-body">
            ...
            <div className="delivery-option">
              <div className="toggle-section">
                {restaurantDetail.deliverable?<div
                  className={
                ...
                >
                  ...
                  <label for="test1" class="delivery">
                    Delivery<br></br>
                    <span>{restaurantDetail.delivery_time || "-- min"}</span>
                  </label>
                  <img
                    src={`../../images/${
                      deliveryOption !== "delivery"
                  ...
                  className="payment-item delivery-item delivery-box decativate delivery-deactivate"
                >
                  <input
                    type="radio"
                    id="test1"
                ...
                >
                  ...
                  <label for="test2" class="store-pick">
                    Store Pick up<br></br>
                    <span>
                      {restaurantDetail.store_pickup_time || "-- min"}
                    </span>
                  </label>
                  <img
                    src={`../../images/${
                  ...
                  className="payment-item delivery-item store-box delivery-deactivate"
                >
                  <input
                    type="radio"
                    id="test2"
                  ...
                  <>
                    {cart_item_objs_v1[item.variant_id] !== 0 ? (
                      <div className="added-food-box">
                        <div
                          className={
                            item.veg ? "summery-veg-item" : "summery-food-item"
                          }
                        >
            ...
            {cartItem.length>0&&<div class="subtotal-sec">
              <div class="subtotal-head">
                <h6>Subtotal</h6>
                <p>£{handleTotalPrice()}</p>
              </div>
              <p>Taxes and other Charges</p>
            </div>}
